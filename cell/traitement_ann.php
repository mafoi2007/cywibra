...
<head>
	...
	<title><?php echo $_SESSION['sexeUser'].' '.$_SESSION['nomUser'];?> : Traitements Annuels</title>
	<script>
			function goView(){
				var xhr = getXhr()
				...
				xhr.open("POST", "traitement_ann/ajaxViewNt.php", true);
			...
			function goTraitNt(){
				...
				// Ici on va voir comment faire du POST
				xhr.open("POST", "traitement_ann/ajaxTraitNt.php", true);
				// Ne pas oublier xa pour le POST 
				xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
				// Ne pas oublier de poster les arguments 
				// C'est-à-dire l'id de la Classe par exemple
			...
			function goTraitMoy(){
				...
				// Ici on va voir comment faire du POST
				xhr.open("POST", "traitement_ann/ajaxTraitMoy.php", true);
				// Ne pas oublier xa pour le POST 
				xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
				// Ne pas oublier de poster les arguments 
				// C'est-à-dire l'id de la Classe par exemple
			...
			function goViewAll(){
				...
				// Ici on va voir comment faire du POST
				xhr.open("POST", "traitement_ann/ajaxViewNoteAll.php", true);
				// Ne pas oublier xa pour le POST 
				xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
				// Ne pas oublier de poster les arguments 
				// C'est-à-dire l'id de la Classe par exemple
...
<body>
	...
	<div id="body">
		<h1>Traitements Annuels</h1>
		<ul>
			<?php /*<li><h3><a 
				href="traitement_ann.php?choix=<?php echo sha1('etatRempl'); ?>#body2">
				Etat de remplissage</a></h3></li> */ ?>
			<li><h3><a 
				href="traitement_ann.php?choix=<?php echo sha1('traitNote'); ?>#body2">
				Traitement des Notes</a></h3></li>
			
			<li><h3><a 
				href="traitement_ann.php?choix=<?php echo sha1('traitMoy'); ?>#body2">
				Traitement des Moyennes</a></h3></li>
			<li><h3><a 
				href="traitement_ann.php?choix=<?php echo sha1('viewNoteAll'); ?>#body2">
	...
	<?php
		if(isset($_GET['choix'])){ // ON A FAIT UN CHOIX 
			if($_GET['choix']==sha1('traitNote')){
				include_once('traitement_ann/traitNote.php');
			}elseif($_GET['choix']==sha1('traitMoy')){
				include_once('traitement_ann/traitMoy.php');
			}elseif($_GET['choix']==sha1('viewNoteAll')){
				include_once('traitement_ann/viewNoteAll.php');
