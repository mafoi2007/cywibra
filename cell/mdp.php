...
<body>
	...
	<div id="body">
		<h1>mots de passe</h1>
		<ul>
			<li><h3><a href="mdp.php?choix=<?php echo sha1('allpwd'); ?>#body2">Mot de passe enseignant</a></h3></li>
			<li><h3><a href="mdp.php?choix=<?php echo sha1('mypwd'); ?>#body2">Mon mot de passe</a></h3></li>
		</ul>
	</div>
		<?php 
		if(isset($_GET['choix'])){
			...
			echo "<div id='body2'>";
				if($choix==sha1('allpwd')){
					require_once('mdp/allpwd.php');
				}elseif($choix==sha1('mypwd')){
					require_once('mdp/mypwd.php');
				}else{
